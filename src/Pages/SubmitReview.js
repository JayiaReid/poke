...
export default function SubmitReview() {
    ...
    return (
        <div id='submitpage' style={{ display: 'flex', justifyContent: 'center', alignItems: 'center', minHeight: '100vh', backgroundColor: 'black' }}>
                ...
                <Form onSubmit={handleSubmit}>
                    <div className="form-group">
                        <textarea
                            ...
                            style={{ minHeight: '150px', background: "black", color: "orange" }}
                        ></textarea>
                    </div>
